...
export const IconlyLinkedinSquare: FC<IconlyIconProps> = ({
  size = 24,
  color = "#000000",
}) => {
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.75 5.38889C2.75 3.93147 3.93147 2.75 5.38889 2.75H18.6111C20.0685 2.75 21.25 3.93147 21.25 5.38889V18.6111C21.25 20.0685 20.0685 21.25 18.6111 21.25H5.38889C3.93147 21.25 2.75 20.0685 2.75 18.6111V5.38889ZM5.38889 4.25C4.7599 4.25 4.25 4.7599 4.25 5.38889V18.6111C4.25 19.2401 4.7599 19.75 5.38889 19.75H18.6111C19.2401 19.75 19.75 19.2401 19.75 18.6111V5.38889C19.75 4.7599 19.2401 4.25 18.6111 4.25H5.38889Z"
        fill={color}
      ></path>
    </svg>
  );
